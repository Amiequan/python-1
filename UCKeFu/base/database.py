...
class DataBase(object):
    ...
    def sql_read_and_insert(self,HostAdress,UserName,PassWord,
                            Database,CharacterSet,Port,Table1,Table2):
    ...
    '''连接数据库'''
    def sql_connect(self, HostAdress,UserName,PassWord,
                    Database,Port,CharacterSet,Connect_Satement):
        # 打开数据库连接
    ...
    '''数据库创建表'''
    def sql_create_table(self,HostAdress,UserName,PassWord,
                         Database,Port,CharacterSet,Create_Statement):
        # 打开数据库连接
        db = pymysql.connect(host=HostAdress,  # 测试主机地址 'localhost'
                             user=UserName,  # 用户名    'root'
                             password=PassWord,  # 用户密码   None
    ...
    '''数据库插入数据'''
    def sql_insert_data(self,HostAdress,UserName,PassWord,
                        Database,Port,CharacterSet,Insert_Statement):
    ...
    '''数据库查询操作'''
    def sql_custom_queries(self,HostAdress,UserName,PassWord,
                           Database,Port,CharacterSet,Custom_Queries_Statement):
        # 打开数据库连接
        db = pymysql.connect(host=HostAdress,  # 测试主机地址 'localhost'
                             user=UserName,  # 用户名    'root'
                             password=PassWord,  # 用户密码   None
    ...
    '''数据库数据更新或删除记录'''
    def sql_update_or_del(self,HostAdress,UserName,PassWord,
                          Database,Port,CharacterSet,Update_Del_Statement):
        # 打开数据库连接
        db = pymysql.connect(host=HostAdress,  # 测试主机地址 'localhost'
                             user=UserName,  # 用户名    'root'
                             password=PassWord,  # 用户密码   None
